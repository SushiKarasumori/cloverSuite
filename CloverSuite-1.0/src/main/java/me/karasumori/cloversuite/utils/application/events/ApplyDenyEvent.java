...
public class ApplyDenyEvent extends Event {
    ...
    public ApplyDenyEvent(Application application) { eventApplication = application; }

    public ApplyDenyEvent(Player player, Application application) {
